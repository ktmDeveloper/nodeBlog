...
const REPO_URL =
  "https://api.github.com/repos/ktmDeveloper/coding-challenges/contents";

ccRouter.get("/", function (req, res, next) {
  ...
  fetch(url, {
    ...
    .then((res) => {
      if (!res.ok) {
        throw new Error(
          "An error happened while making a request to GitHub API"
        );
      }
