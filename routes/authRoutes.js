...
.post('/signUp/',[
    ...
    check('firstName','First Name should only contain letters').isLength({ min: 1 }).isAscii(),
    check('lastName','Last Name should only contain letters').isLength({ min: 1 }).isAscii(),
    check('password','Password should be at least 3 characters long').isLength({ min: 3 }).isAscii()
